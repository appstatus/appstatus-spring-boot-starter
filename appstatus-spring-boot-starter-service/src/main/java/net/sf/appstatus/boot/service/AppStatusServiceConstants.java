...
/**
 * Constants of AppStatusServiceConfig.
 * 
 * @author Franck Stephanovitch
 *
 */
public final class AppStatusServiceConstants {

    /** MinMaxDelay. */
    public static final int MIN_MAX_DELAY = 10;

    /**
     * Constructor.
     */
    private AppStatusServiceConstants() {
        // Nothing to do
    }
}
